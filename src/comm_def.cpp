...
unordered_map<s_hash_rule_key, int, has_rule_key_hash> g_hash_rule_tab;
...
// Hierarchy : 编号，索引公共库
////////////////////////////////////////////////////////
glb_cfg_c::glb_cfg_c(string file_name)
{
...
// Hierarchy : 编号，索引公共库
////////////////////////////////////////////////////////
void glb_cfg_c::read_cfg_file(string file_name)
{
    ...
    while (getline(in_file, read_line)) {
        ...
        while (split_char != NULL) {
            ...
            {
                string tmp_str = string(split_char);
...
void glb_cfg_c::gen_cfg_table()
{
    ...
    if (g_hash_tab_relate.size() != 0) {
        ...
        for (int i = 0; i < hash_rule_num; i++) {
            ...
            g_hash_rule_tab.insert(make_pair(fill_hash_key, fill_fid));
        }
    }
