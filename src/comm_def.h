...
struct s_pkt_desc
{
    ...
    {
        return (rhs.type == type && rhs.fid == fid && rhs.sid == sid && rhs.did == did && rhs.fsn == fsn && rhs.len == len && rhs.pri == pri && rhs.sport == sport && rhs.dport == dport && rhs.qid == qid && rhs.vldl == vldl && rhs.csn == csn && rhs.sop == sop && rhs.eop == eop);
    }
};
